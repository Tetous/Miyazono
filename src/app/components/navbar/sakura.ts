...
export var Sakura = function Sakura(selector, options?) {
  ...
  this.createPetal = function () {
    ...
    var animationsArr = ["fall "+fallTime+ "s linear 0s 1", "".concat(blowAnimation, " ").concat((fallTime > 30 ? fallTime : 30) - 20 + randomInt(0, 20), "s linear 0s infinite"), "".concat(swayAnimation, " ").concat(randomInt(2, 4), "s linear 0s infinite")];
    ...
    petal.style.width = width+ "px"; // Remove petals of which the animation ended.
